...
namespace WeatherApplication
{
    public class WeatherModel
    {
        ...
        public async Task<WeatherData> GetWeatherAsync(string cityName)
        {
            ...
            try
            {
                ...
                return deserializer.DeserializeWeatherData(await json.FetchWeatherData(cityName)) ?? throw new Exception("Weather data deserialization failed.");
            }
    ...
    //The custom exception was removed from here to its own class to follow SOLID principles.
    //It also was renamed to CustomException
